...
|-------|---------|---------|
| [`chat`](chat/) | chat | Conversational assistant for Slack/Discord threads — answer repo/PR/issue questions, guide users to the natural-language workflow triggers. |
